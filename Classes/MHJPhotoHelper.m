...
@property (nonatomic, copy) MHJPhotoHelperBlock selectImageBlock;
...
#pragma mark - MHJPhotoHelper
@interface MHJPhotoHelper()
...
+ (instancetype)creatWithSourceType:(UIImagePickerControllerSourceType)sourceType config:(LXFPhotoConfig *)config {
    // 创建
    MHJPhotoHelper *imagePicker = [[MHJPhotoHelper alloc] init];
 ...
 *  选择照片后回调
 */
- (void)getSourceWithSelectImageBlock:(MHJPhotoHelperBlock)selectImageBlock {
